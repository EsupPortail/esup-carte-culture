...
public class AppliVersion {
    ...
    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("carteCultureVersion");
    ...
    public String getCarteCultureVersion() {
        return this.carteCultureVersion;
    }

    public void setCarteCultureVersion(String carteCultureVersion) {
